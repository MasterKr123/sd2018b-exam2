...
def repository_changed():
    ...
    if itWasMerged:
        ...
        json_image_url = 'https://raw.githubusercontent.com/MasterKr123/sd2018b-exam2/' + pull_id + '/images.json'
        ...
        for service in images_json["images"]:
            ...
            if image_type == 'Docker':
                image_url = 'https://raw.githubusercontent.com/MasterKr123/sd2018b-exam2/' + pull_id + '/' + service_name + '/Dockerfile'
                ...
                image_url = 'https://raw.githubusercontent.com/MasterKr123/sd2018b-exam2/' + pull_id + '/' + service_name + '/AMI'
                file_response=requests.get(image_url)
                file = open("AMI","w")
                file.write(str(file_response.content, 'utf-8'))
                file.close()
